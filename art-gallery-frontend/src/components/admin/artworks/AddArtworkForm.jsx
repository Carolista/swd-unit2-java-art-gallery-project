...
const AddArtworkForm = ({ artists, categories, refetch }) => {
    ...
    const sortedArtists = sortObjByString([...artists], "lastName");
    const sortedCategories = sortObjById([...categories], "title");
    ...
    // TODO: Arrange categories in columns to reduce length of page
    /*
